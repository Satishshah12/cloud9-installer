...
# Silakan ganti username di bawah ini sesuai keinginan
CUSTOM_USER="admin"
# Password akan digenerate otomatis secara acak, atau ganti manual di sini jika ingin static
...
-e PGID=0 \
-e TZ=${TIMEZONE} \
-e AUTH_USER=${CUSTOM_USER} \
-e AUTH_PASS=${CUSTOM_PASS} \
-p ${PORT}:8000 \
-v ${WORKSPACE}:/code \
